#!/bin/bash
#SBATCH --job-name boed-c-eval                      # Job name
...
#SBATCH --error ces_eval.err
#SBATCH --output ces_eval.output
...
python3 select_policy_env.py --src="$1"itr_20000.pkl --dest="$1"evaluation_upper.log --edit_type="w" --seq_length=10 --bound_type=upper --n_contrastive_samples=10000000 --n_parallel=50 --n_samples=2000 --seed=1 --env="ces" --source_d=2 --source_k=2 --source_b=0.1 --source_m=0.0001 --source_obs_sd=0.5 --ces_d=6 --ces_obs_sd=0.005 --docking_d=1
