#!/bin/bash
#SBATCH --job-name boed-source                      # Job name
...
#SBATCH --error boed_err_source.err
#SBATCH --output boed_out_source.output
...
python3 Adaptive_Source_REDQ.py --n-parallel=100 --n-contr-samples=100000 --n-rl-itr=20001 --log-dir="boed_results_source/source"  --bound-type=lower --id=$1 --budget=30 --discount=0.9 --buffer-capacity=10000000 --tau=0.001 --pi-lr=0.0001 --qf-lr=0.0003 --M=2 --ens-size=2 --lstm-q-function=False --layer-norm=False --dropout=0
