"""
Use SUNRISE/DroQ to learn an agent that adaptively designs constant elasticity of
...
def main(n_parallel=1, budget=1, n_rl_itr=1, n_cont_samples=10, seed=0,
    ...
    def sunrise_ces(ctxt=None, n_parallel=1, budget=1, n_rl_itr=1,
                ...
                reset_interval=256000, resets=False, weighted_bellman_temp=20.):
    ...
    sunrise_ces(n_parallel=n_parallel, budget=budget, n_rl_itr=n_rl_itr,
