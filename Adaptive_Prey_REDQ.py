"""
Use REDQ to learn an agent that adaptively designs prey population experiments
"""
import argparse
...
from pyro.policies import AdaptiveGumbelSoftmaxPolicy
...
def main(n_parallel=1, budget=1, n_rl_itr=1, n_cont_samples=10, seed=0,
    ...
    def redq_prey(ctxt=None, n_parallel=1, budget=1, n_rl_itr=1,
    ...
    redq_prey(n_parallel=n_parallel, budget=budget, n_rl_itr=n_rl_itr,
